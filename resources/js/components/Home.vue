    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="card statistics-card-1">
                <div class="card-body">
                    <img src="/public/Admin/assets/images/widget/img-status-4.svg" alt="img" class="img-fluid img-bg">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="card statistics-card-1">
                <div class="card-body">
                    <img src="/public/Admin/assets/images/widget/img-status-5.svg" alt="img" class="img-fluid img-bg">
                    <div class="d-flex align-items-center justify-content-between mb-3 drp-div">
        ...
        <div class="col-md-4 col-sm-12">
            <div class="card statistics-card-1 bg-brand-color-1">
                <div class="card-body">
                    <img src="/public/Admin/assets/images/widget/img-status-6.svg" alt="img" class="img-fluid img-bg">
                    <div class="d-flex align-items-center justify-content-between mb-3 drp-div">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td><img src="/public/Admin/assets/images/widget/p1.jpg" alt="prod img"
                                        class="img-fluid"></td>
                                <td>PNG002413</td>
                                <td>Jane Elliott</td>
                                <td>06-01-2017</td>
                            ...
                            <tr>
                                <td><img src="/public/Admin/assets/images/widget/p2.jpg" alt="prod img"
                                        class="img-fluid"></td>
                                <td>PNG002344</td>
                                <td>John Deo</td>
                                <td>05-01-2017</td>
                            ...
                            <tr>
                                <td><img src="/public/Admin/assets/images/widget/p3.jpg" alt="prod img"
                                        class="img-fluid"></td>
                                <td>PNG002653</td>
                                <td>Eugine Turner</td>
                                <td>04-01-2017</td>
                            ...
                            <tr>
                                <td><img src="/public/Admin/assets/images/widget/p4.jpg" alt="prod img"
                                        class="img-fluid"></td>
                                <td>PNG002156</td>
